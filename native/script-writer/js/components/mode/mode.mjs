...
const moreOptionsList = document.querySelectorAll(".mode");

for (let moreOptions of moreOptionsList) {
    const displayIcon = moreOptions.querySelector(".mode__icon");
    const content = moreOptions.querySelector(".mode__content");
